...
Sempre que o agente iniciar as atividades do Ralph Loop por um `/agent-runner` para iniciar um projeto zero, ele deve pensar se o PRD original gerado é raso.
...
Isso serve para que no futuro, ao criar o Plano (`prd.json`), o Ralph Loop já extraia as tarefas detalhistas não apenas do PRD inicial (que pode ser raso), mas deste escopo corporativo. 
